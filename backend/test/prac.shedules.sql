-- Вставка расписания для фильма "Архитекторы общества"
INSERT INTO schedule (id, daytime, hall, rows, seats, price, taken, film_id) VALUES
...
-- Вставка расписания для фильма "Недостижимая утопия"
INSERT INTO schedule (id, daytime, hall, rows, seats, price, taken, film_id) VALUES
...
-- Вставка расписания для фильма "Звёздное путешествие"
INSERT INTO schedule (id, daytime, hall, rows, seats, price, taken, film_id) VALUES
...
-- Вставка расписания для фильма "Стражи Гримуара"
INSERT INTO schedule (id, daytime, hall, rows, seats, price, taken, film_id) VALUES
...
-- Вставка расписания для фильма "Парадокс Нексуса"
INSERT INTO schedule (id, daytime, hall, rows, seats, price, taken, film_id) VALUES
...
-- Вставка расписания для фильма "Сон в летний день"
INSERT INTO schedule (id, daytime, hall, rows, seats, price, taken, film_id) VALUES
